...
download() {
    ...
    mv ./jre* ./jre
    echo JRE downloaded
    wget -O server.jar "https://papermc.io/api/v1/paper/1.16.4/latest/download"
...
echo "Running server..."
java -Xmx1G -Xms1G -jar server.jar nogui #Change vanilla.jar to forge.jar to run Forge
echo "Exit code $?"
